...
class CouchDatabase(dict):
    ...
    def database_partition_url(self, partition_key):
        """
        Get database partition URL.

        :param str partition_key: Partition key.
        :return: Database partition URL.
        :rtype: str
        """
    ...
    def partition_metadata(self, partition_key):
        """
        Retrieves the remote partitioned database metadata dictionary.

        :param str partition_key: Partition key.
        :returns: Dictionary containing partitioned database metadata details.
        :rtype: dict
        """
...
class CloudantDatabase(CouchDatabase):
    ...
    def get_partitioned_search_result(self, partition_key, ddoc_id, index_name,
        ...
        # Remove once fixed in service!
        query_params['partition'] = partition_key
